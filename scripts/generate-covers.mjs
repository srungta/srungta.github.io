...
const covers = [
  {
    path: "assets/images/distrib/DISTRIB01/cover.svg",
    eyebrow: "DISTRIBUTED SYSTEMS",
    title: ["Load balancing", "from scratch"],
    accent: "#ff705d",
    motif: "network",
  },
  { path: "assets/images/distrib/DISTRIB02/cover.svg", eyebrow: "AZURE NETWORKING", title: ["Azure VPN", "Gateway"], accent: "#62cbc9", motif: "gateway" },
  { path: "assets/images/jekyll/JEKYLL01/cover.svg", eyebrow: "JEKYLL", title: ["Feedback via", "GitHub Issues"], accent: "#f9cc55", motif: "feedback" },
  { path: "assets/images/jekyll/JEKYLL02/cover.svg", eyebrow: "JEKYLL", title: ["A series of", "articles"], accent: "#ff705d", motif: "series" },
  { path: "assets/images/llm/LLMCODE01/cover.svg", eyebrow: "LLM ENGINEERING", title: ["LLM-friendly", "codebases"], accent: "#62cbc9", motif: "code" },
  { path: "assets/images/redis/REDIS1/cover.svg", eyebrow: "REDIS", title: ["Introduction", "to Redis"], accent: "#ff705d", motif: "database" },
  { path: "assets/images/redis/REDIS2/cover.svg", eyebrow: "REDIS", title: ["Redis inside", "Docker"], accent: "#62cbc9", motif: "container" },
  { path: "assets/images/redis/REDIS3/cover.svg", eyebrow: "REDIS", title: ["Using the", "Redis CLI"], accent: "#f9cc55", motif: "terminal" },
  { path: "assets/images/redis/REDIS4/cover.svg", eyebrow: "REDIS", title: ["Metrics with", "INFO"], accent: "#62cbc9", motif: "metrics" },
  { path: "assets/images/redis/REDIS5/cover.svg", eyebrow: "REDIS + GRAFANA", title: ["Redis meets", "Grafana"], accent: "#ff705d", motif: "dashboard" },
  { path: "assets/images/start-right/STARTRIGHT-01/cover.svg", eyebrow: "START RIGHT", title: ["The what, why", "and how of nonce"], accent: "#f9cc55", motif: "key" },
  { path: "assets/images/start-right/STARTRIGHT-02/cover.svg", eyebrow: "START RIGHT", title: ["Content Security", "Policy"], accent: "#62cbc9", motif: "shield" },
  { path: "assets/images/start-right/linters/cover.svg", eyebrow: "FRONTEND FOUNDATIONS", title: ["Add", "linters"], accent: "#f9cc55", motif: "lint" },
  { path: "assets/images/start-right/tests/cover.svg", eyebrow: "FRONTEND FOUNDATIONS", title: ["Add", "tests"], accent: "#62cbc9", motif: "tests" },
  { path: "assets/images/start-right/bundles/cover.svg", eyebrow: "FRONTEND FOUNDATIONS", title: ["Track", "bundles"], accent: "#ff705d", motif: "bundle" },
  { path: "assets/images/start-right/telemetry/cover.svg", eyebrow: "FRONTEND FOUNDATIONS", title: ["Unify", "telemetry"], accent: "#62cbc9", motif: "telemetry" },
  { path: "assets/images/start-right/components/cover.svg", eyebrow: "FRONTEND FOUNDATIONS", title: ["Use", "components"], accent: "#f9cc55", motif: "components" },
  { path: "assets/images/start-right/types/cover.svg", eyebrow: "FRONTEND FOUNDATIONS", title: ["Use strong", "types"], accent: "#ff705d", motif: "types" },
  { path: "assets/images/web/WEB01/cover.svg", eyebrow: "WEB COMPONENTS", title: ["Building with", "FAST Element"], accent: "#62cbc9", motif: "browser" },
  { path: "assets/images/web/WEB06/cover.svg", eyebrow: "THE WEB", title: ["Internet", "duct tape"], accent: "#f9cc55", motif: "protocol" },
];
