...
permalink: /p/connecting-redis-to-grafana
cover: /assets/images/REDIS/REDIS-05/cover.svg
image: /assets/images/REDIS/REDIS-05/cover.png
author: srungta
tags: 
- Redis
- Docker
...
![Grafana admin login screen](/assets/images/REDIS/REDIS-05/grafana-login.png)
...
![Grafana add data source](/assets/images/REDIS/REDIS-05/grafana-add-data-source.png)

Search for `redis` in the search bar
![Grafana search Redis](/assets/images/REDIS/REDIS-05/grafana-redis-data-source.png)
...
![Grafana Redis localhost](/assets/images/REDIS/REDIS-05/grafana-redis-localhost.png)
...
![Grafana redis IP](/assets/images/REDIS/REDIS-05/grafana-redis-ip.png)
...
![Grafana redis with service name](/assets/images/REDIS/REDIS-05/grafana-redis-instance.png)
