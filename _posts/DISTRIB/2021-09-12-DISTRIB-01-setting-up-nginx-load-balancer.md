...
cover: /assets/images/DISTRIB/DISTRIB-01/cover.svg
image: /assets/images/DISTRIB/DISTRIB-01/cover.png
author: srungta
tags: 
- Nginx
- Load Balancer
...
![Creating a virtual network](/assets/images/DISTRIB/DISTRIB-01/create-a-virtual-network.gif)
...
![Creating worker VMs](/assets/images/DISTRIB/DISTRIB-01/create-a-worker-vm.gif)
...
![Connect using Bastion](/assets/images/DISTRIB/DISTRIB-01/connect-using-bastion.gif)
...
![Installing Nginx](/assets/images/DISTRIB/DISTRIB-01/install-nginx-on-worker.gif)
...
![Updating the default page](/assets/images/DISTRIB/DISTRIB-01/updating-default-nginx-page.gif)
...
![Create the frontend VM](/assets/images/DISTRIB/DISTRIB-01/create-the-load-balancer-vm.gif)
...
![Add load balancer config](/assets/images/DISTRIB/DISTRIB-01/configure-load-balancer-config.gif)
...
![Load balanciong demo](/assets/images/DISTRIB/DISTRIB-01/routing-demo.gif)
Fin.
